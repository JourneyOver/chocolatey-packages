...
$packageName = 'jackett'
$url = 'https://github.com/Jackett/Jackett/releases/download/v0.8.225/Jackett.Installer.Windows.exe'
$checksum = '5540e0d687c2f5c18bf896b665b148ac9b396439e7389926cdba3e8b2c0c3823'
