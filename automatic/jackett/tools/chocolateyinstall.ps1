...
$packageName = 'jackett'
$url = 'https://github.com/Jackett/Jackett/releases/download/v0.8.216/Jackett.Installer.Windows.exe'
$checksum = '6ab8da6756b4133a745b2e0568d001fbfca3dde608ca5f5a4fedfc92e0fb83b0'
