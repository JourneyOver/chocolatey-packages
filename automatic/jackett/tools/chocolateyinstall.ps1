...
$packageName = 'jackett'
$url = 'https://github.com/Jackett/Jackett/releases/download/v0.8.175/Jackett.Installer.Windows.exe'
$checksum = '745fa1319a82ad965779a32f84a047a17b59d541d608069cdcbaf9cd9e4a1963'
