...
$registrypaths = $('HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\TheSage-7', 'HKLM:\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\TheSage-7')
$version = '7.18.2678'
