...
$options = [ordered]@{
  ...
  Report      = @{
    ...
    Params = @{                                          #Report parameters:
      ...
      UserMessage     = "[Ignored](#ignored) | [Update report](https://gist.github.com/$Env:gist_id) | [Build](https://ci.appveyor.com/project/JourneyOver/chocolatey-packages-uw7ly) | **USING AU NEXT VERSION**"       #  Markdown, Text: Custom user message to show
    }
  }
